        ...
        describe('Class', function () {
			describe('define', function () {
	            it("standard success", function () {
	                // arrange
					var subject = resolver.resolve('sdk/runtime.node');
	                ...
	                // act
					var classDef = window.Class.define(_constructor, members);
			...
			describe('derive', function () {
	            it("First Level - members available", function () {
	                ...
	                // act
					var baseClassDef = window.Class.define(_constructor, members);
					var concereteClassDef = window.Class.derive(baseClassDef, concereteConstructor, concreteMembers);
